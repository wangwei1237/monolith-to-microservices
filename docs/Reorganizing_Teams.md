...
如果已经对生产路径进行了建模（我非常支持），则可以在现有视图上覆盖这些行为和职责的所有权边界。另外，如图2-9所示的一些简单的事情，也可以很好地工作。仅从所有涉及到的角色中选择[**利益相关者**](Domain_Driven_Design.md#fn_译注2)，然后组成一个小组来集体“头脑风暴”公司软件发布的所有行为活动。
